...
if (!window.Spark.RestaurantAttributesLandingPage) window.Spark.RestaurantAttributesLandingPage = {};
window.Spark.RestaurantAttributesLandingPage.Index = {
...
Output.Write("\n    <title>");
Output.Write(string.Format(Resources.Shared.RestaurantAttributesLandingPage.Strings.PageTitleFormat, Model.Display.RestaurantAttribute.Name, Model.Display.Location.Name));
Output.Write("</title>");
} DisposeOutputScope();
Output.Write("\n");
OutputScope('metaDescription'); {
Output.Write("\n    <meta name=\"description\" content=\"");
Output.Write(string.Format(Resources.Shared.RestaurantAttributesLandingPage.Strings.MetaDescription, Model.Display.RestaurantAttribute.Name, Model.Display.Location.Name));
Output.Write("\"/>");
{
...
Output.Write(string.Format(Resources.Shared.RestaurantAttributesLandingPage.Strings.HeaderTitleFormat, mastheadModel.Display.RestaurantAttribute.Name, mastheadModel.Display.Location.Name));
Output.Write("\n                    </span>\n                </h1>\n");
{
var search = Model;
...
Output.Write(Html.RenderResourceToJson(typeof(Resources.Shared.RestaurantAttributesLandingPage.Strings)));
Output.Write("\n            }\n        }\n    };\n    </script>");
} DisposeOutputScope();
Output.Write("\n");
...
{
Output.Write("<!-- build:js(Web) /s/Scripts/generated/bundle-app-restaurant-attributes.js -->\n<script src=\"Scripts/src/RestaurantAttributesLandingPage/App.js\"></script>\n<!-- endbuild -->");
}
Output.Write("\n\n    <script>\n        OT.RestaurantAttributesLandingPage.init();\n    </script>\n");
} DisposeOutputScope();
Output.Write("\n");

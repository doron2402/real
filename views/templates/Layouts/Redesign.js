...
Output.Write("\n<!DOCTYPE html>\n<html lang=\"");
Output.Write(Model.DomainCulture.Language);
...
Output.Write("\n  ");
if (Content['jsHead']) {
Output.Write(Content['jsHead']);}
Output.Write("\n</head>\n<body class=\"search ");
Output.Write(Html.CurrentTheme(Model.DomainCulture));
Output.Write(" pagetype-");
Output.Write(Model.Request.CssClassForPageType);
Output.Write(" domain-");
...
Output.Write("\">\n    ");
Output.Write(Html.AntiForgeryToken());
Output.Write("\n\n    <div class=\"master-container\"><!-- hide-footer -->");
if (Content['view']) {
Output.Write(Content['view']);}
Output.Write("\n    </div>\n\n    <div id=\"tooltip\" class=\"tooltip\"></div>\n    <div id=\"results_modal\" class=\"tooltip\"></div>\n    <div id=\"filters_modal\" class=\"modal filters-modal\"></div>\n    <div id=\"location_modal\" class=\"modal location-modal\"></div>\n");
if (Content['data']) {
Output.Write(Content['data']);}
Output.Write("\n");
if (Content['resources']) {
Output.Write(Content['resources']);}
Output.Write("\n  \n    <script src=\"/s/Scripts/generated/bundle_views_redesign.js\"></script>\n");
